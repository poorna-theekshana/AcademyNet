        ...
        <div className="container-fluid">
            <nav className="navbar navbar-expand-lg navbar-light bg-light fixed-top">
                <h4 className="navbar-brand mt-1">
                    <Link to="/home">Edu Learning</Link>
                </h4>
                    ...
                    <ul className="navbar-nav">
                        <li className="nav-item active">
                            <button type="button" className="btn">
                                <Link to={`/profile`}><li>{name.toUpperCase()}</li></Link>
                            </button>
                        </li>
                        {(user.role === 'Instructor' || user.role === 'Admin') && (
                        <li className="nav-item">
                            <button type="button" className="btn">
                                <Link to="/addCourse"><li>CREATE COURSE</li></Link>
                            </button>
                        </li>)}
                        {(user.role === 'Instructor' || user.role === 'Admin') && (
                        <li className="nav-item">
                            <button type="button" className="btn">
                                <Link to="/createQuiz"><li>CREATE QUIZ</li></Link>
                            </button>
                        </li>)}
                        {(user.role === 'Instructor' || user.role === 'Admin') && (
                            <li className="nav-item">
                                <button type="button" className="btn">
                                    <Link to="/learnerProgress"><li>LEARNER PROGRESS</li></Link>
                                </button>
                            </li>
                        )}
                        ...
                        {user.role === 'Admin' && ( // Render only for Admin role
                            <li className="nav-item">
                                <button type="button" className="btn">
                                    <Link to="/notcourseList"><li>APPROVAL LIST</li></Link>
                                </button>
                            </li>
                        )}
                        ...
                        {user.role === 'Admin' && ( // Render only for Admin role
                            <li className="nav-item">
                                <button type="button" className="btn">
                                    <Link to="/courseList"><li>COURSE LIST</li></Link>
                                </button>
                            </li>
                        )}
                        {user.role === 'Instructor' && ( // Render only for Admin role
                            <li className="nav-item">
                                <button type="button" className="btn">
                                    <Link to="/courseCreated"><li>COURSE LIST</li></Link>
                                </button>
                            </li>
                        )}
                        {(user.role === 'Learner' || user.role === 'Admin') && (
                            <li className="nav-item">
                                <button type="button" className="btn">
                                    <Link to="/myCourses"><li>MY COURSES {courseLength} </li></Link>
                                </button>
                            </li>
                        )}
